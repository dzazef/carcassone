...
def test():  # test capabilities of check_for_points_after_game
    ...
    print(t1.check_for_points_after_move_castle())  # scenario 1 after finishing a move, returns {}

    print(t1.check_for_points_after_game_castle())  # scenario 2 after finishing a game, returns {}

    print(t2.check_for_points_after_game_castle())  # scenario 3 after finishing a game, returns {1: 4}
